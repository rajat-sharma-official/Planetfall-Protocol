...
=== ask_fragile ===
YOU: Is that scrap really so sensitive?
...
=== ask_scrap ===
YOU: The scrap I've found looks like that, with those runes.
...
=== ask_leave ===
YOU: Should I leave you alone?
HARVEL: If you left every time you felt uncertain, we’d never get anywhere.

-> menu_stage2

=== menu_stage2 ===
HARVEL: Anything else?

+ [What do the runes do?] -> ask_runes
...
=== ask_repair ===
YOU: If I learned to translate these runes, could I use this scrap to repair my ship?
...
=== ask_background ===
YOU: How did you become the outpost's mechanist?
