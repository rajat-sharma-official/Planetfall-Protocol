...
=== a1 ===
Julisa: The <b>shutdown</b>. The planet-wide silence.
Julisa: Every surviving text agrees on one thing:
Julisa: a single <b>power source</b>. A single <b>heartbeat</b> in the world.
...
=== a2 ===
Julisa: My leading theory? The ancients <b>drew power</b>
 from the sun.
...
Julisa: I think there’s a <b>pattern</b> we haven’t earned the right to prove yet.

-> a_menu


=== hub_b ===
Julisa: You’ve been around <b>Solace</b>.
...
Julisa: But we see the <b>pattern</b>: one backbone system, one failure, total silence.
Julisa: <b>Solace</b> calls it “a warning.” We call it “a problem to solve.”
...
Julisa: something that distributed <b>power</b>.
...
Julisa: That sounds like a <b>machine</b> with a job… and a failure.
...
Julisa: When I ask <b>Sanya</b>, she smiles and says, “focus on what we can prove.”
